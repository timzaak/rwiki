...
| document | 文档检索与引用 | [document/document-retrieval-and-citations.md](document/document-retrieval-and-citations.md) | Draft | 分块、窗口扩展、metadata 上下文、来源引用 |
...
| infrastructure | 可观测性 | [infrastructure/observability.md](infrastructure/observability.md) | Planned | tracing/span 输出、OTLP 配置、shutdown flush |
